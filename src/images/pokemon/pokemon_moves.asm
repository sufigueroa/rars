...
acid_armor:
	.word 	3	# ID
			7	# Type Poison
			0	# Categoria (0-Status, 1-Especial, 2-Fisico)
			0	# Poder
			0	# Precision
			20	# PP
...
barrage:
	.word 	7	# ID
			0	# Type Normal
			2	# Categoria (0-Status, 1-Especial, 2-Fisico)
			15	# Poder
			85	# Precision
			20	# PP
